...
from helper_files.legend_saver import save_legend_png, scatter_handles
...
if __name__ == "__main__":
    ...
    ax.set_xlabel("sample size", loc="right", fontsize=24)
    ax.set_ylabel("")
    ax.margins(0)
    ...
    colors_legend = [smc_color]
    handles = scatter_handles(labels=labels, colors=colors_legend, sizes=100)
    save_legend_png(
        handles=handles,
        filename=f"{output_dir}/7x7_wasserstein_scatter_plot_legend.png",
        ncol=1,
        frameon=True,
        dpi=200,
        label_fontsize=14,
