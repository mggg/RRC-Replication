...
def make_rev_forest_comparison(
    ...
    plot_tick_step = 100_000
    plot_tick_list = list(range(100_000, 1_000_000, plot_tick_step))
    ...
    plt.savefig(
        out_path.joinpath("Wasserstein_distances_5x5_compare_reversible_forest.png"),
        bbox_inches="tight",
    )
...
def make_recom_comparison(
    ...
    if n_accepted > 3_000_000:
        sns.lineplot(
            ...
            linewidth=3,
            color=colors[3],
            label=f"ReComA ({n_accepted/1_000_000:0.1f}M accepted) vs Truth",
        )
        sns.lineplot(
            x=was_recomB_ticks,
            ...
            linewidth=3,
            color=colors[4],
            label=f"ReComB ({n_accepted/1_000_000:0.1f}M accepted) vs Truth",
        )
        sns.lineplot(
            x=was_recomC_ticks,
            ...
            linewidth=3,
            color=colors[5],
            label=f"ReComC ({n_accepted/1_000_000:0.1f}M accepted) vs Truth",
        )
        sns.lineplot(
            x=was_recomD_ticks,
            ...
            linewidth=3,
            color=colors[6],
            label=f"ReComD ({n_accepted/1_000_000:0.1f}M accepted) vs Truth",
        )
        plot_tick_list = list(range(500_000, n_accepted + 1_000_000, 500_000))
        ax.set_xticks(plot_tick_list)
        ax.set_xticklabels([f"{i/1_000_000:0.1f}M" for i in plot_tick_list])
        ax.set_ylim(-0.05, 0.41)
    else:
        sns.lineplot(
            x=was_recomA_ticks,
            y=was_distances_recomA,
    ...
    plt.savefig(
        out_path.joinpath(
            f"Wasserstein_distances_5x5_recom_comparison_{n_accepted}_n_accepted.png"
        ),
        bbox_inches="tight",
    )
